...
Generate C headers automatically from Rust `#[no_mangle] extern "C"` functions. CI step verifies generated headers match committed versions.
...
- Semantic versioning for C headers (MAJOR/MINOR/PATCH)
- Struct layouts frozen at MAJOR.MINOR boundaries
- All exported functions use `#[no_mangle]` with `extern "C"`
- Breaking changes require 2-release deprecation period
