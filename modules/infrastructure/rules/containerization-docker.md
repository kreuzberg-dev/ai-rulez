...
Best practices for container builds and deployment at kreuzberg.dev.
...
- BuildKit mount caches: `--mount=type=cache,target=/usr/local/cargo/registry`
...
Semantic version + latest + branch + commit SHA.
Example: `myapp:1.2.3`, `myapp:latest`, `myapp:abc1234f`
